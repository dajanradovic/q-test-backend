...
<form method="POST" action="<?php echo ($_ENV['BASE_URL'] . '/books') ?>">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleInputEmail1" name="title" placeholder="Enter title" required>
    </div>
    <div class="form-group">
  ...
  <div class="form-group">
      ...
      <input type="text" class="form-control" id="exampleInputEmail1"  name="isbn" placeholder="Enter isbn" required>
    </div>
  <div class="form-group">
      <label for="exampleInputEmail1">Format</label>
      <input type="text" class="form-control" id="exampleInputEmail1"  name="format" placeholder="Enter format" required>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Number of pages</label>
      <input type="number" class="form-control" id="exampleInputEmail1"  name="number_of_pages" placeholder="Enter number of pages" required>
    </div>
    <div class="form-group">
      <label for="exampleInputEmail1">Release date</label>
      <input type="date" class="form-control" id="exampleInputEmail1"  name="release_date" required>
    </div>
    <div class="form-group">
